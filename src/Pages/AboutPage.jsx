...
import gambar from '../assets/images/rakev2.jpeg';
import gambar2 from '../assets/images/ito.jpeg';
import gambar3 from '../assets/images/idan.png';
import gambar4 from '../assets/images/suares.jpeg';
import gambar5 from '../assets/images/emil.jpeg';
import gambar6 from '../assets/images/bagasreswara.png';
          ...
          <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-3 sm:gap-16 px-12 sm:px-16">
            <div className="relative h-80 flex flex-col justify-center items-center border border-slate-400 shadow-lg rounded-lg group">
              <div className=" front-face text-center">
                <img className="w-48 h-48 rounded-full mb-4" src={gambar} alt="" />
            ...
            <div className="relative h-80 flex flex-col justify-center items-center border border-slate-400 shadow-md rounded-lg group">
              <div className=" front-face text-center">
                <img className="w-48 h-48 rounded-full mb-4 object-cover" src={gambar2} alt="" />
            ...
            <div className=" relative h-80 flex flex-col justify-center items-center border border-slate-400 shadow-md rounded-lg group">
              <div className=" front-face text-center ">
                <img className="w-48 h-48 rounded-full mb-4 object-cover" src={gambar3} alt="" />
            ...
            <div className="relative h-80 flex flex-col justify-center items-center border border-slate-400 shadow-lg rounded-lg group">
              <div className=" front-face text-center">
                <img className="w-48 h-48 rounded-full mb-4" src={gambar4} alt="" />
                <h4 className="font-bold">Naufal Wafi</h4>
                <p>Back-end Developer</p>
              </div>
              {/* <div className="absolute top-0 left-0 w-full h-full p-8 text-center back-face transform rotate-y-180 ">
                <h2 className="font-bold mb-5">About Me</h2>
            ...
            <div className="relative h-80 flex flex-col justify-center items-center border border-slate-400 shadow-lg rounded-lg group">
              <div className=" front-face text-center">
                <img className="w-48 h-48 rounded-full mb-4" src={gambar5} alt="" />
                <h4 className="font-bold">Emil Al Fikri</h4>
                <p>UI/UX Designer</p>
              </div>
              {/* <div className="absolute top-0 left-0 w-full h-full p-8 text-center back-face transform rotate-y-180 ">
                <h2 className="font-bold mb-5">About Me</h2>
            ...
            <div className="relative h-80 flex flex-col justify-center items-center border border-slate-400 shadow-lg rounded-lg group">
              <div className=" front-face text-center">
                <img className="w-48 h-48 rounded-full mb-4" src={gambar6} alt="" />
                <h4 className="font-bold">Bagas Reswara</h4>
